...
return [
	'routes' => [
		...
		['name' => 'googleAPI#deleteBackgroundJobs', 'url' => '/delete-background-jobs', 'verb' => 'DELETE'],
		['name' => 'googleAPI#importContacts', 'url' => '/import-contacts', 'verb' => 'GET'],
		['name' => 'googleAPI#registerSyncContacts', 'url' => '/sync-contacts', 'verb' => 'GET'],
		['name' => 'googleAPI#unregisterSyncContacts', 'url' => '/unsync-contacts', 'verb' => 'GET'],
		['name' => 'googleAPI#setSyncContacts', 'url' => '/set-sync-contacts', 'verb' => 'GET'],
